...
public class Hid
{
	...
	{
		[FieldOffset(0)]
		public int dbch_size = Marshal.SizeOf(typeof(DevBroadcastDeviceInterfaceBuffer));
	...
	public static IntPtr RegisterHIDNotification(IntPtr recipient)
	{
		...
		Marshal.StructureToPtr((object)new DevBroadcastDeviceInterfaceBuffer(5), intPtr, false);
