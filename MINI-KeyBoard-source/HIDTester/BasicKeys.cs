...
public class BasicKeys : UserControl
{
	...
	private void InitializeComponent()
	{
		...
		this.KEY_A.Click += new EventHandler(KEY_A_Click);
		...
		this.KEY_B.Click += new EventHandler(KEY_B_Click);
		...
		this.KEY_C.Click += new EventHandler(KEY_C_Click);
		...
		this.KEY_D.Click += new EventHandler(KEY_D_Click);
		...
		this.KEY_E.Click += new EventHandler(KEY_E_Click);
		...
		this.KEY_F.Click += new EventHandler(KEY_F_Click);
		...
		this.KEY_G.Click += new EventHandler(KEY_G_Click);
		...
		this.KEY_H.Click += new EventHandler(KEY_H_Click);
		...
		this.KEY_I.Click += new EventHandler(KEY_I_Click);
		...
		this.KEY_J.Click += new EventHandler(KEY_J_Click);
		...
		this.KEY_K.Click += new EventHandler(KEY_K_Click);
		...
		this.KEY_W.Click += new EventHandler(KEY_W_Click);
		...
		this.KEY_V.Click += new EventHandler(KEY_V_Click);
		...
		this.KEY_U.Click += new EventHandler(KEY_U_Click);
		...
		this.KEY_T.Click += new EventHandler(KEY_T_Click);
		...
		this.KEY_S.Click += new EventHandler(KEY_S_Click);
		...
		this.KEY_R.Click += new EventHandler(KEY_R_Click);
		...
		this.KEY_Q.Click += new EventHandler(KEY_Q_Click);
		...
		this.KEY_P.Click += new EventHandler(KEY_P_Click);
		...
		this.KEY_O.Click += new EventHandler(KEY_O_Click);
		...
		this.KEY_N.Click += new EventHandler(KEY_N_Click);
		...
		this.KEY_M.Click += new EventHandler(KEY_M_Click);
		...
		this.KEY_L.Click += new EventHandler(KEY_L_Click);
		...
		this.KEY_8.Click += new EventHandler(KEY_8_Click);
		...
		this.KEY_7.Click += new EventHandler(KEY_7_Click);
		...
		this.KEY_6.Click += new EventHandler(KEY_6_Click);
		...
		this.KEY_5.Click += new EventHandler(KEY_5_Click);
		...
		this.KEY_4.Click += new EventHandler(KEY_4_Click);
		...
		this.KEY_3.Click += new EventHandler(KEY_3_Click);
		...
		this.KEY_2.Click += new EventHandler(KEY_2_Click);
		...
		this.KEY_1.Click += new EventHandler(KEY_1_Click);
		...
		this.KEY_9.Click += new EventHandler(KEY_9_Click);
		...
		this.KEY_Z.Click += new EventHandler(KEY_Z_Click);
		...
		this.KEY_Y.Click += new EventHandler(KEY_Y_Click);
		...
		this.KEY_X.Click += new EventHandler(KEY_X_Click);
		...
		this.KEY_0.Click += new EventHandler(KEY_0_Click);
		...
		this.KEY_F12.Click += new EventHandler(KEY_F12_Click);
		...
		this.KEY_F11.Click += new EventHandler(KEY_F11_Click);
		...
		this.KEY_F10.Click += new EventHandler(KEY_F10_Click);
		...
		this.KEY_F9.Click += new EventHandler(KEY_F9_Click);
		...
		this.KEY_F8.Click += new EventHandler(KEY_F8_Click);
		...
		this.KEY_F7.Click += new EventHandler(KEY_F7_Click);
		...
		this.KEY_F6.Click += new EventHandler(KEY_F6_Click);
		...
		this.KEY_F5.Click += new EventHandler(KEY_F5_Click);
		...
		this.KEY_F4.Click += new EventHandler(KEY_F4_Click);
		...
		this.KEY_F3.Click += new EventHandler(KEY_F3_Click);
		...
		this.KEY_F2.Click += new EventHandler(KEY_F2_Click);
		...
		this.KEY_F1.Click += new EventHandler(KEY_F1_Click);
		...
		this.KEY_ESC.Click += new EventHandler(KEY_ESC_Click);
		...
		this.KEY_PrtSc.Click += new EventHandler(KEY_PrtSc_Click);
		...
		this.KEY_PauseBreak.Click += new EventHandler(KEY_PauseBreak_Click);
		...
		this.KEY_INS.Click += new EventHandler(KEY_INS_Click);
		...
		this.KEY_DEL.Click += new EventHandler(KEY_DEL_Click);
		...
		this.KEY_HOME.Click += new EventHandler(KEY_HOME_Click);
		...
		this.KEY_PgUg.Click += new EventHandler(KEY_PgUg_Click);
		...
		this.KEY_PgDn.Click += new EventHandler(KEY_PgDn_Click);
		...
		this.KEY_End.Click += new EventHandler(KEY_End_Click);
		...
		this.KEY_SubSub.Click += new EventHandler(KEY_SubSub_Click);
		...
		this.KEY_ADDADD.Click += new EventHandler(KEY_ADDADD_Click);
		...
		this.KEY_BACKSPACE.Click += new EventHandler(KEY_BACKSPACE_Click);
		...
		this.KEY_Tabel.Click += new EventHandler(KEY_Tabel_Click);
		...
		this.KEY_kuohao.Click += new EventHandler(KEY_kuohao_Click);
		...
		this.KEY_kuohao2.Click += new EventHandler(KEY_kuohao2_Click);
		...
		this.KEY_shu.Click += new EventHandler(KEY_shu_Click);
		...
		this.KEY_fenhao.Click += new EventHandler(KEY_fenhao_Click);
		...
		this.KEY_yinghao.Click += new EventHandler(KEY_yinghao_Click);
		...
		this.KEY_Enter.Click += new EventHandler(KEY_Enter_Click);
		...
		this.KEY_bolanghao.Click += new EventHandler(KEY_bolanghao_Click);
		...
		this.KEY_douhao.Click += new EventHandler(KEY_douhao_Click);
		...
		this.KEY_juhao.Click += new EventHandler(KEY_juhao_Click);
		...
		this.KEY_wenhao.Click += new EventHandler(KEY_wenhao_Click);
		...
		this.KEY_jiantou_left.Click += new EventHandler(KEY_jiantou_left_Click);
		...
		this.KEY_jiantou_Up.Click += new EventHandler(KEY_jiantou_Up_Click);
		...
		this.KEY_jiantou_Down.Click += new EventHandler(KEY_jiantou_Down_Click);
		...
		this.KEY_jiantou_right.Click += new EventHandler(KEY_jiantou_right_Click);
		...
		this.KEY_add.Click += new EventHandler(KEY_add_Click);
		...
		this.KEY_sub.Click += new EventHandler(KEY_sub_Click);
		...
		this.KEY_multiply.Click += new EventHandler(KEY_multiply_Click);
		...
		this.KEY_DIV.Click += new EventHandler(KEY_DIV_Click);
		...
		this.KEY_NUM.Click += new EventHandler(KEY_NUM_Click);
		...
		this.KEY_MIN_0.Click += new EventHandler(KEY_MIN_0_Click);
		...
		this.KEY_MIN_9.Click += new EventHandler(KEY_MIN_9_Click);
		...
		this.KEY_MIN_8.Click += new EventHandler(KEY_MIN_8_Click);
		...
		this.KEY_MIN_7.Click += new EventHandler(KEY_MIN_7_Click);
		...
		this.KEY_MIN_6.Click += new EventHandler(KEY_MIN_6_Click);
		...
		this.KEY_MIN_5.Click += new EventHandler(KEY_MIN_5_Click);
		...
		this.KEY_MIN_4.Click += new EventHandler(KEY_MIN_4_Click);
		...
		this.KEY_MIN_3.Click += new EventHandler(KEY_MIN_3_Click);
		...
		this.KEY_MIN_2.Click += new EventHandler(KEY_MIN_2_Click);
		...
		this.KEY_MIN_1.Click += new EventHandler(KEY_MIN_1_Click);
		...
		this.KEY_MIN_Dot.Click += new EventHandler(KEY_MIN_Dot_Click);
		...
		this.KEY_CapsLock.Click += new EventHandler(KEY_CapsLock_Click);
		...
		this.KEY_SpaceKey.Click += new EventHandler(KEY_SpaceKey_Click);
		...
		this.KEY_ScrollLock.Click += new EventHandler(KEY_ScrollLock_Click);
		this.KEY_Menu.Font = new System.Drawing.Font("宋体", 14.25f, FontStyle.Regular, GraphicsUnit.Point, 134);
		...
		this.KEY_Menu.Click += new EventHandler(KEY_Menu_Click);
		...
		this.Key_Ctrl.Click += new EventHandler(Key_Ctrl_Click);
		...
		this.Key_Shift.Click += new EventHandler(Key_Shift_Click);
		...
		this.Key_Alt.Click += new EventHandler(Key_Alt_Click);
		...
		this.Key_Win.Click += new EventHandler(Key_Win_Click);
        AutoScaleDimensions = new SizeF(6f, 12f);
        AutoScaleMode = AutoScaleMode.Font;
        Controls.Add(this.Key_Win);
        Controls.Add(this.Key_Alt);
        Controls.Add(this.Key_Shift);
        Controls.Add(this.Key_Ctrl);
        Controls.Add(this.KEY_Menu);
        Controls.Add(this.KEY_ScrollLock);
        Controls.Add(this.KEY_SpaceKey);
        Controls.Add(this.KEY_CapsLock);
        Controls.Add(this.KEY_MIN_Dot);
        Controls.Add(this.KEY_NUM);
        Controls.Add(this.KEY_MIN_0);
        Controls.Add(this.KEY_MIN_9);
        Controls.Add(this.KEY_MIN_8);
        Controls.Add(this.KEY_MIN_7);
        Controls.Add(this.KEY_MIN_6);
        Controls.Add(this.KEY_MIN_5);
        Controls.Add(this.KEY_MIN_4);
        Controls.Add(this.KEY_MIN_3);
        Controls.Add(this.KEY_MIN_2);
        Controls.Add(this.KEY_MIN_1);
        Controls.Add(this.KEY_DIV);
        Controls.Add(this.KEY_multiply);
        Controls.Add(this.KEY_sub);
        Controls.Add(this.KEY_add);
        Controls.Add(this.KEY_jiantou_right);
        Controls.Add(this.KEY_jiantou_Down);
        Controls.Add(this.KEY_jiantou_Up);
        Controls.Add(this.KEY_jiantou_left);
        Controls.Add(this.KEY_wenhao);
        Controls.Add(this.KEY_juhao);
        Controls.Add(this.KEY_douhao);
        Controls.Add(this.KEY_bolanghao);
        Controls.Add(this.KEY_Enter);
        Controls.Add(this.KEY_yinghao);
        Controls.Add(this.KEY_fenhao);
        Controls.Add(this.KEY_shu);
        Controls.Add(this.KEY_kuohao2);
        Controls.Add(this.KEY_kuohao);
        Controls.Add(this.KEY_Tabel);
        Controls.Add(this.KEY_BACKSPACE);
        Controls.Add(this.KEY_ADDADD);
        Controls.Add(this.KEY_SubSub);
        Controls.Add(this.KEY_End);
        Controls.Add(this.KEY_PgDn);
        Controls.Add(this.KEY_PgUg);
        Controls.Add(this.KEY_HOME);
        Controls.Add(this.KEY_DEL);
        Controls.Add(this.KEY_INS);
        Controls.Add(this.KEY_PauseBreak);
        Controls.Add(this.KEY_PrtSc);
        Controls.Add(this.KEY_ESC);
        Controls.Add(this.KEY_F12);
        Controls.Add(this.KEY_F11);
        Controls.Add(this.KEY_F10);
        Controls.Add(this.KEY_F9);
        Controls.Add(this.KEY_F8);
        Controls.Add(this.KEY_F7);
        Controls.Add(this.KEY_F6);
        Controls.Add(this.KEY_F5);
        Controls.Add(this.KEY_F4);
        Controls.Add(this.KEY_F3);
        Controls.Add(this.KEY_F2);
        Controls.Add(this.KEY_F1);
        Controls.Add(this.KEY_0);
        Controls.Add(this.KEY_8);
        Controls.Add(this.KEY_7);
        Controls.Add(this.KEY_6);
        Controls.Add(this.KEY_5);
        Controls.Add(this.KEY_4);
        Controls.Add(this.KEY_3);
        Controls.Add(this.KEY_2);
        Controls.Add(this.KEY_1);
        Controls.Add(this.KEY_9);
        Controls.Add(this.KEY_Z);
        Controls.Add(this.KEY_Y);
        Controls.Add(this.KEY_X);
        Controls.Add(this.KEY_W);
        Controls.Add(this.KEY_V);
        Controls.Add(this.KEY_U);
        Controls.Add(this.KEY_T);
        Controls.Add(this.KEY_S);
        Controls.Add(this.KEY_R);
        Controls.Add(this.KEY_Q);
        Controls.Add(this.KEY_P);
        Controls.Add(this.KEY_O);
        Controls.Add(this.KEY_N);
        Controls.Add(this.KEY_M);
        Controls.Add(this.KEY_L);
        Controls.Add(this.KEY_K);
        Controls.Add(this.KEY_J);
        Controls.Add(this.KEY_I);
        Controls.Add(this.KEY_H);
        Controls.Add(this.KEY_G);
        Controls.Add(this.KEY_F);
        Controls.Add(this.KEY_E);
        Controls.Add(this.KEY_D);
        Controls.Add(this.KEY_C);
        Controls.Add(this.KEY_B);
        Controls.Add(this.KEY_A);
        Name = "BasicKeys";
