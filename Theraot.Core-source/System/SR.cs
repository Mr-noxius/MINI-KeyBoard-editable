...
internal static class SR
{
	...
	internal static string ArgumentMustBeFieldInfoOrPropertInfo => "Argument must be either a FieldInfo or PropertyInfo";

	internal static string ArgumentMustBeFieldInfoOrPropertInfoOrMethod => "Argument must be either a FieldInfo, PropertyInfo or MethodInfo";
	...
	internal static string ExpressionNotSupportedForNullableType => "The expression '{0}' is not supported for nullable type '{1}'";

	internal static string ExpressionNotSupportedForType => "The expression '{0}' is not supported for type '{1}'";
	...
	internal static string ExtensionNotReduced => "Extension should have been reduced.";

	internal static string FaultBlockNotSupported => "Fault blocks are not supported";
	...
	internal static string FilterBlockNotSupported => "Filter blocks are not supported";
	...
	internal static string HomogenousAppDomainRequired => "Dynamic operations can only be performed in homogenous AppDomain.";

	internal static string IllegalNewGenericParams => "Cannot create instance of {0} because it contains generic parameters";
	...
	internal static string InvalidCast => "Cannot cast from type '{0}' to type '{1}";

	internal static string InvalidLvalue => "Invalid lvalue for assignment: {0}.";

	internal static string InvalidMemberType => "Invalid member type: {0}.";
	...
	internal static string InvalidOperation => "Invalid operation: '{0}'";
	...
	internal static string ListInitializerWithZeroMembers => "List initializers must contain at least one initializer";
	...
	internal static string MethodDoesNotExistOnType => "No method '{0}' exists on type '{1}'.";
	...
	internal static string NonReducibleExpressionExtensionsNotSupported => "Non-reducible expression extensions are not supported";
	...
	internal static string OperatorNotImplementedForType => "The operator '{0}' is not implemented for type '{1}'";
	...
	internal static string PropertyTyepMustMatchSetter => "Property type must match the value type of setter";
	...
	internal static string UnexpectedCoalesceOperator => "Unexpected coalesce operator.";
	...
	internal static string UnhandledConvert => "Unhandled convert: {0}";

	internal static string UnhandledExpressionType => "Unhandled Expression Type: {0}";

	internal static string UnhandledUnary => "Unhandled unary: {0}";

	internal static string UnknownBindingType => "Unknown binding type";

	internal static string UnknownLiftType => "unknown lift type: '{0}'.";
