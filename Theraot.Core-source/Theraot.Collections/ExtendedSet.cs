...
public sealed class ExtendedSet<T> : ICloneable, ISet<T>, ICollection<T>, IEnumerable<T>, IEnumerable
{
	...
	public bool Remove(T item, IEqualityComparer<T> comparer)
	{
		...
		using (IEnumerator<T> enumerator = _wrapped.RemoveWhereEnumerable((T input) => comparer.Equals(input, item)).GetEnumerator())
		{
